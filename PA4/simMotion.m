...
[P,Q] = meshgrid(-3:3); % Provide a gridwork (you choose the size)
X = wall(1)+w(1,1)*P+w(1,2)*Q; % Compute the corresponding cartesian coordinates
Y = wall(2)+w(2,1)*P+w(2,2)*Q; %   using the two vectors in w
Z = wall(3)+w(3,1)*P+w(3,2)*Q;
...
for i = 1:round(n/frames):n
    ...
    plot3(T(1,4),T(2,4),T(3,4),'r.','MarkerSize',4);
